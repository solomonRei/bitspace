            ...
            <div class="block-container">
                <div id="breadcrumbs">
                    <ul>
                        ...
                        <li>
                            {{ $categoryCurrent->categoryStrings[0]->name }}
                        </li>
                    </ul>
                </div>
                <div class="wrapper">
                        ...
                        <div class="sidebar_search-filters">
                            ...
                            <div class="form-groups mt-30">
                                ...
                                <div class="form-control">
                                    <select name="choices" id="city-select" class="custom-select" placeholder="Выберите город">
                            ...
                            <div class="form-groups mt-50">
                                ...
                                <div class="form-control_checkboxes">
                                    <div class="form-control checkbox">
                                        <input type="checkbox" id="age-groups-1">
                                        <label for="age-groups-1">
                                            Взрослые
                                        </label>
                                    </div>
                                    <div class="form-control checkbox">
                                        <input id="age-groups-2" type="checkbox">
                                        <label for="age-groups-2">
                                            До 30 лет
                                        </label>
                                    </div>
                                    <div class="form-control checkbox">
                                        <input id="age-groups-3" type="checkbox">
                                        <label for="age-groups-3">
                                            Студенты
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-groups  mt-30">
                                ...
                                <div class="form-control checkbox">
                                    <input id="profiles-with-photo" type="checkbox">
                                    <label for="profiles-with-photo">
                                        Только с фото
                                    </label>
                                </div>
                                <div class="form-control checkbox">
                                    <input id="profiles-with-review" type="checkbox">
                    ...
                    <div class="main-content">
                        ...
                        <div class="pagination default center mt-50">
                           {{ $users['users']->links('vendor.pagination.custom') }}
                        </div>
...
@section('footer-scripts')
    <script>
        $('#city-select').on('change', function() {
            let city = this.value;
            let url= "{{Request::url()}}";
            location.href = url + "?city=" + this.value;
        });
    </script>
@endsection
